...
- **Dynamic Birth–Death SBM (VEM) notebook**  
  ([notebook here](https://github.com/gbayolo26/dynamic-bdsbm-vem-specific-birth-death-rates/blob/main/Dynamic_Birth-Death_SBM_VEM_specific_birth_death_rates.ipynb))
